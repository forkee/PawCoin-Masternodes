...
unsigned int nStakeMinAge = 8 * 60 * 60; // 20 min
...
const string strMessageMagic = "Pawcoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    if(nBestHeight >= 1 && nBestHeight <= 18000){
      nSubsidy = 10 * COIN;
    } else if(nBestHeight >= 18001 && nBestHeight < 35000){
      nSubsidy = 20 * COIN;
    } else if(nBestHeight >= 35001 && nBestHeight < 75000){
      nSubsidy = 40 * COIN;
    } else if(nBestHeight >= 75001 && nBestHeight < 100000){
      nSubsidy = 50 * COIN;
...
#ifdef ENABLE_WALLET
// Pawcoin: attempt to generate suitable proof-of-stake
