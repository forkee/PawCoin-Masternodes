...
#define START_MASTERNODE_PAYMENTS_TESTNET 1521288000
#define START_MASTERNODE_PAYMENTS 1521288000

static const int64_t DARKSEND_COLLATERAL = (20000*COIN); //10000
...
static const int64_t MAX_MONEY = 43298969 * COIN; //50M
